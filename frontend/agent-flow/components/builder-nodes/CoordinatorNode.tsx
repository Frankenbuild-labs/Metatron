...
const CoordinatorNode: React.FC<CoordinatorNodeProps> = ({ id, data, isConnectable, onCopyApiKeyToAllCoordinators }) => {
  ...
  return (
    <div style={{
      background: 'rgba(147, 51, 234, 0.1)', // Purple tint for coordinator
      backdropFilter: 'blur(8px)',
      border: '1px solid rgba(147, 51, 234, 0.4)', // Purple border
      borderRadius: '0.5rem',
      boxShadow: '0 4px 24px -1px rgba(0, 0, 0, 0.2), 0 0 8px rgba(147, 51, 234, 0.3)', // Purple glow
      width: width,
      maxWidth: 200,
      color: '#fff5f5',
      fontSize: '0.85rem',
